   ...
   <li>รูปภาพ ต่างๆ (รูปโปรหากมี) ทางลูกค้าควรจัดหามาเอง อย่างน้อย 5 รูป png, jpg, gif</li>
    ...
    <li>บัตรเครดิต สำหรับชำระค่าโฆษณา ให้กลับGoogle Ads สามารถใช้บัตรของทางลูกค้าเองได้เลย หรือ จะใช้บัตรที่ทางเราเตรียมไว้ให้ก็ได้ ไม่บวกเพิ่ม(แนะนำ) </li>
     <li>ขอบคุณลูกค้าทุกท่านที่ใช้บริการทีมงานเราครับผม</li>
             ...
             <Image src="/GoogleAds/gg.jpg" alt="Ads สายเทา" width={480} height={480} className="imgp" />
   
          
      <Link href="/">โฆษณา Google Ads สายเทา</Link>

          <Image src="/GoogleAds/Google_Ads(1).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
       <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
       <Image src="/GoogleAds/Google_Ads(2).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
       <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
       <Image src="/GoogleAds/Google_Ads(3).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
        <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
        <Image src="/GoogleAds/Google_Ads(4).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
        <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
        <Image src="/GoogleAds/Google_Ads(5).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
        
                <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
                <Image src="/GoogleAds/Google_Ads(6).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
        <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
     
        <Image src="/GoogleAds/Google_Ads(7).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
       <Link href="/">โฆษณา Google Ads สายเทา</Link>
    
       <Image src="/GoogleAds/Google_Ads(8).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
        <Link href="/">โฆษณา Google Ads สายเทา</Link>
     
        <Image src="/GoogleAds/Google_Ads(9).jpg" alt="Ads สายเทา" width={1040} height={1040} className="imgp" />
       <Link href="/">โฆษณา Google Ads สายเทา</Link>
