      ...
      <div className="text-center">
          ...
          <div className="page-banner home-banner">
            <div className="row align-items-center flex-wrap-reverse h-100">
              ...
              <img src="/img/ads.jpg" alt="Ads สายเทา" width='100%'  />
            ...
            <div className="col-lg-4">
              <div className="card-service wow fadeInUp">
                <div className="header">
                  ...
                  <div className="image-container">
              <img src="/img/Facebook.png" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Facebook Ads สายเทา</Link>
                </div>
                <div className="body">
            ...
            <div className="col-lg-4">
              <div className="card-service wow fadeInUp">
                ...
                <div className="header">
                  ...
                  <div className="image-container">
              <img src="/img/Google.png" alt="Google Ads" width='100%'/>
            ...
            <div className="col-lg-4">
              <div className="card-service wow fadeInUp">
                <div className="header">
                  ...
                  <div className="image-container">
              <img src="/img/class.jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 py-3 wow fadeInRight">
              <div className="img-fluid py-3 text-center">
                ...
                <div className="image-container">
              <img src="/img/logo.png" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Facebook สายเทา</Link>
              </div>
            </div>
          </div>
        </div> 
          ...
          <div className="row row-cols-1 row-cols-md-3 g-4">
            <div className="col">
              <div className="card">
                ...
                <div className="image-container">
              <img src="/Google/Google (1).jpg" alt="Facebook Ads" width='100%'/>
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (2).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (3).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (4).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (5).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (6).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (7).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
            ...
            <div className="col">
              ...
              <div className="image-container">
              <img src="/Google/Google (8).jpg" alt="Facebook Ads" width='100%' />
            </div><Link href="/">โฆษณา Google Ads สายเทา</Link>
